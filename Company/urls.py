...
urlpatterns = [
    ...
    path('department-leader-dashboard/<int:dept_id>/', views.department_leader_dashboard_with_id, name='department_leader_dashboard_with_id'),
    ...
    path('company/engineer/<int:userid>/summary/summary.html', views.summary, name='summary'),
